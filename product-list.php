                                        ...
                                        <div class="col-md-4">
                                            <div class="product-price-range">
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <a href="#" class="dropdown-item">Rs.0 to Rs.50</a>
                                                        <a href="#" class="dropdown-item">Rs.51 to Rs.100</a>
                                                        <a href="#" class="dropdown-item">Rs.101 to Rs.150</a>
                                                        <a href="#" class="dropdown-item">Rs.151 to Rs.200</a>
                                                        <a href="#" class="dropdown-item">Rs.201 to Rs.250</a>
                                                        <a href="#" class="dropdown-item">Rs.251 to Rs.300</a>
                                                        <a href="#" class="dropdown-item">Rs.301 to Rs.350</a>
                                                        <a href="#" class="dropdown-item">Rs.351 to Rs.400</a>
                                                        <a href="#" class="dropdown-item">Rs.401 to Rs.450</a>
                                                        <a href="#" class="dropdown-item">Rs.451 to Rs.500</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
