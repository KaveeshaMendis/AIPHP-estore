                    ...
                    <div class="col-lg-4">
                        <div class="checkout-inner">
                            <div class="checkout-summary">
                                <h1>Cart Total</h1>
                                <p>Product Name<span>Rs.99</span></p>
                                <p class="sub-total">Sub Total<span>Rs.99</span></p>
                                <p class="ship-cost">Shipping Cost<span>Rs.1</span></p>
                                <h2>Grand Total<span>Rs.100</span></h2>
                            </div>
